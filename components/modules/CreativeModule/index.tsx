            ...
            >
              {subModules?.map((subModule, ii) => {
                switch (subModule._type) {
                  case 'ctas':
                    return (
                      <CTAsSubModule module={subModule} className={cn(stegaClean(textAlign) === 'center' && 'justify-center')} key={ii} />
                    );
                  ...
                  case 'icon':
                    return (
                      <IconSubModule module={subModule} className={cn(stegaClean(textAlign) === 'center' && '[&_img]:mx-auto')} key={ii} />
                    );

                  case 'image':
                    return <ImageSubModule module={subModule} imageWidth={imageWidth * colSpan} key={ii} />;
