            ...
            <blockquote className="space-y-6">
              ...
              {testimonial.author && (
                <div className="inline-flex items-center gap-2">
                  <Img className="size-[40px] rounded-full object-cover" image={testimonial.author?.image} imageWidth={80} />

                  <dl className="text-left">
                    <dt>{testimonial.author?.name}</dt>

                    {testimonial.author?.title && <dd className="text-sm">{testimonial.author?.title}</dd>}
                  </dl>
                </div>
              )}
            </blockquote>
