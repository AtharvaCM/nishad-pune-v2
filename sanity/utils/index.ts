...
export const group = (S: StructureBuilder, title: string, items: (ListItemBuilder | ListItem | Divider)[]): ListItemBuilder =>
...
export function count(arr: Array<unknown>, singular: string = 'item', plural?: string) {
